...
var renderData = function renderData() {
  ...
  var cards = arguments.length > 1 ? arguments[1] : undefined;

  if (data.length) {
    cards.innerHTML = data.map(function (_ref) {
...
var renderDetailsData = function renderDetailsData() {
  ...
  if (data.length) {
    container.innerHTML = data.map(function (_ref2) {
...
var BASE_URL = "http://www.omdbapi.com/?apikey=1320d6a&"; //fetch movies by title
...
function _fetchMovies() {
  _fetchMovies = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(search, type) {
    var page,
        response,
        receivedData,
        _args = arguments;
...
function _fetchMoviesById() {
  _fetchMoviesById = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(movieId) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            receivedData = _context2.sent;
            return _context2.abrupt("return", receivedData);
...
var _requests = require("./requests/requests.js");
