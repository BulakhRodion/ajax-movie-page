...
var BASE_URL = "http://www.omdbapi.com/?apikey=1320d6a&";
var search = document.getElementById("searchInput");
var form = document.getElementById("searchForm");
var cards = document.getElementById("cards");
var details = document.getElementById("details");
var pagWrapper = document.getElementById("pagWrapper");
var type = document.querySelector(".movie__type-selector:checked"); //fetch movies by title
...
function _fetchMovies() {
  _fetchMovies = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(search, type) {
    var page,
        response,
        receivedData,
        _args4 = arguments;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            _context4.next = 4;
            return fetch("".concat(BASE_URL, "&s=").concat(search, "&type=").concat(type, "&page=").concat(page));
...
function fetchMoviesById(_x3) {
  return _fetchMoviesById.apply(this, arguments);
} //detail func


function _fetchMoviesById() {
  _fetchMoviesById = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(movieId) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return fetch("".concat(BASE_URL, "&i=").concat(movieId));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return fetchMoviesById(search[i].imdbID);
...
function remove() {
  var prevPagination = document.querySelector(".uk-pagination");
...
function getPagination(totalRes) {
  ...
  var pagElem = document.querySelector(".uk-pagination");
  UIkit.pagination(pagElem, {
    items: totalRes,
    itemsOnPage: 10,
    displayedPages: 4
  });
  var pages = pagination.childNodes;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetchMovies(search.value, type.value, pages[i].innerText);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return fetchMovies(search.value, type.value);
          ...
          case 4:
            ...
            if (Search) {
              renderData(Search); //Details

              getDetails(Search); //Pagination
